...
The FIT sampling bottles were refrigerated within an hour of having stool placed in them. They were refrigerated for up to 48 hours before being analyzed for hemoglobin quantification. The hemoglobin quantification took place at room temperature. The cartridges would have been exposed to room temperature for an hour, at most. Then they were stored at -20C until they were later thawed so that an aliquot could be taken for DNA extraction. Unfortunately we don’t have any data about the growth of bacteria in the buffer. We simply tried to minimize exposure to room temperature. 
